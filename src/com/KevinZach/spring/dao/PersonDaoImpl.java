package com.KevinZach.spring.dao;
...
public class PersonDaoImpl extends JdbcDaoSupport implements IPersonDao {
	...
	public void initDatabase() {
		...
		String sql = " create table if not exists tb_person " + " (id int auto_increment, " + " name varchar(255), "
	...
	public void addPerson(Person person) {
		...
		getJdbcTemplate().update(sql,
				new Object[] { person.getName(), person.getSex(), person.getAge(), person.getBirthday(), });
	}
